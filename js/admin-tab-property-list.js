(function($) {
    ...
    function applyPageDesign () {
        var val = $('#p_lodgix_vacation_rentals_page_design').val(),
            iconSetting = $('#p_lodgix_icon_set').parent( ".form-group" );

        if (val == 1) {
            // Grid
            $('.ldgxInventoryList').hide();
            $('.ldgxInventoryGrid').show();
            $('#lodgix_vc_content_grid_3').hide();
            $(iconSetting).show();
        } else if(val == 3){
            $('.ldgxInventoryList').hide();
            $('.ldgxInventoryGrid').hide();
            $('#lodgix_vc_content_grid_3').show();
            $(iconSetting).hide();
        } else {
            // Rows
            $(iconSetting).show();
    ...
    function showTable () {
        if ($('#p_lodgix_vacation_rentals_page_design').val() == 1) {
            ...
            if ($('#p_lodgix_vacation_rentals_page_design').val() == 3) {
                if ($('#p_lodgix_display_search_daily_rates').attr('checked')) {
    ...
    function showDisplayOptions () {
        if ($('#p_lodgix_vacation_rentals_page_design').val() == 1) {
            ...
            $('.ldgxSettingsNewGridOnly').hide();
            $('.ldgxSettingsHideNewGrid').show();
        } else if ($('#p_lodgix_vacation_rentals_page_design').val() == 3) {
            // Grid
            $('.ldgxSettingsRowsOnly').hide();
            $('.ldgxSettingsHideNewGrid').hide();
            $('.ldgxSettingsRowNewGrid').show();
            $('.ldgxSettingsNewGridOnly').show();
        } else {
            // Rows

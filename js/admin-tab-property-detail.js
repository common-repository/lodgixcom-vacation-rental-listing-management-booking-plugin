(function ($) {
    ...
    function applyPageDesign() {
        ...
        if (val == 1) {
            ...
            $('.ldgxPropertyTabs').removeClass('ldgxPropertyTabbedWrapperNew');
            $('.tabHeader').show();
            $('.tabHeaderAlt').hide();
            ...
            $('.ldgxPropertySingle').hide();
            $('.ldgxPropertyTabs').show();
            $('.ldgxPropertyTabs').addClass('ldgxPropertyTabbedWrapperNew');
            $('.tabHeader').hide();
            $('.tabHeaderAlt').show();
            $('.ldgxSettingsPreviewTabsDetails').append($('.ldgxSettingsPreviewContentDetails'));
            $('.ldgxSettingsPreviewTabsCalendar').append($('.ldgxSettingsPreviewContentCalendar'));
            ...
            if (val == 3) {
                $('.singleHeader').hide();
                $('.singleHeaderAlt').show();
            } else {
                $('.singleHeader').show();
                $('.singleHeaderAlt').hide();
            }

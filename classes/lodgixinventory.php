...
class LodgixInventory
{
    ...
    )
    {
        ...
        } elseif ($this->config->get('p_lodgix_vacation_rentals_page_design') == 3) {
            $content = '<div id="lodgix_vc_content" class="ldgxInventoryList ldgxInventoryGrid3">';
        } else {
            ...
            foreach ($properties as $property) {
                ...
                if ($property->main_image_preview) {
                    ...
                    if ($this->config->get('p_lodgix_vacation_rentals_page_design') == 1) {
                        ...
                        if(!$this->config->get('p_lodgix_category_sort')){
                            $sortBy = true;
                        }
                        ...
                        if (!$sortBy && !empty($oldCategoryId)) {
                            if (($counter == 0) || ($oldCategoryId != $property->category_id)) {
                                if ($property->category_id) {
                                    $content .= "<h2 class=\"ldx-category-title\">$property->category_title_long</h2>";
                                } else {
                                    $content .= "<h2 class=\"ldx-category-title\">Other Areas</h2>";
                                }
                                $counter = 0;
                            }
                        }
                        ...
                        if($this->config->get('p_lodgix_vacation_rentals_page_design') == 3){
                            $gridLayout = true;
                        }
